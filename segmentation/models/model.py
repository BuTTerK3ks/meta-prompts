...
from meta_prompts import UNetWrapper


@SEGMENTORS.register_module()
class MetaPromptsSeg(BaseSegmentor):
    ...
    def __init__(self,
        ...
        config = OmegaConf.load('../checkpoints/v1-inference.yaml')
        ...
        text_dim = 768
        print(f'Unet refine step: {self.refine_step}, Query number: {num_prompt}')
